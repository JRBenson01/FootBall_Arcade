...
bots = [bot1, bot2, bot3]
for bot in bots:
    bot.add_sprite("Helm_Red.png")
    bot.add_sprite("Helm_Red_45.png")
    bot.set_speed(0.5)
...
start_button.set_pos(gameWindow.width/2, gameWindow.height/1.5)
start_button.set_normal_color(green)
start_button.set_trigger_color(spring_green)
start_button.set_click_color(brown)

menu_button = button("Back to start")
menu_button.set_size(gameWindow.width/10, gameWindow.height/10)
menu_button.set_pos(gameWindow.width/3, gameWindow.height/1.5)
menu_button.set_normal_color(green)
menu_button.set_trigger_color(spring_green)
menu_button.set_click_color(brown)

next_button = button("Next Level")
next_button.set_size(gameWindow.width/10, gameWindow.height/10)
next_button.set_pos(gameWindow.width/1.5, gameWindow.height/1.5)
next_button.set_normal_color(green)
next_button.set_trigger_color(spring_green)
next_button.set_click_color(brown)

start_message = button("Football Arcade")
start_message.set_size(gameWindow.width/1.5, gameWindow.height/5)
start_message.set_pos(gameWindow.width/2, gameWindow.height/3)
start_message.set_font_size(96)
start_message.no_box()

endzone = button("Endzone")
endzone.set_size(gameWindow.width/16, gameWindow.height)
endzone.set_pos(gameWindow.width - gameWindow.width/32, gameWindow.height/2)
endzone.set_interact(False)
endzone.set_normal_color(white)
endzone.set_order(0)
...
for button in com_buttons:
    button.set_size(gameWindow.width/10, gameWindow.height/10)
    button.set_normal_color(red)
    button.set_trigger_color(red)
    button.set_click_color(red)
...
start_scene.add_piece(fps_display)
start_scene.add_piece(start_message)
start_scene.add_piece(start_button)
...
win_scene.add_piece(start_message)
win_scene.add_piece(menu_button)
...
lose_scene.add_piece(start_message)
lose_scene.add_piece(menu_button)
